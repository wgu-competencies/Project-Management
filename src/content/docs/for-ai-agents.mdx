...
2. **collection.json is a compiled artifact** - Generated from skills/
...
**Complete Collection:**
```
GET https://wgu-competencies.github.io/Project-Management/collection.json
```
...
- `collection.json` → **compiled distribution**
